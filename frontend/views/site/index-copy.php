        ...
        <div class="carousel-inner">
            <div class="item slider1 active">
                ...
                <div class="carousel-caption slider-con">
                    <h2>Welcome to <span>Bahodir BMI.uz</span></h2>
                    <p>Biz bilan ta'limni zabt etilmagan cho'qqilarini zabt eting !!!</p>
                    <a href="#" class="bann-btn-1">Barcha kurslar</a><a href="#" class="bann-btn-2">Ko'proq </a>
                </div>
            </div>
            <div class="item">
                <img src="images/slider/3.jpg" alt="">
                <div class="carousel-caption slider-con">
                    <h2>Education <span> TATU</span></h2>
                    <p>Biz bilan ta'limni zabt etilmagan cho'qqilarini zabt eting !!!</p>
...
<section class="pop-cour">
    <div class="container com-sp pad-bot-70">
        <div class="row">
            <div class="con-title">
                <h2>Mashhur <span>Kurslar</span></h2>
                <p>Biz bilan sifatli bilimlarni oling va o'z qobilyatlaringizni sinab ko'ring !!! </p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div>
                    ...
                    <div class="home-top-cour">
                        ...
                        <div class="col-md-9 home-top-cour-desc">
                            ...
                            <p>Bu kurs davomida backend dasturlashni o'rganasiz</p> <span
                                    class="home-top-cour-rat">4.2</span>
                            <div class="hom-list-share">
                                <ul>
                                    <li><a href="course-details.html"><i class="fa fa-bar-chart" aria-hidden="true"></i>Bog'lanish</a>
                                    </li>
                                    <li><a href="course-details.html"><i class="fa fa-eye" aria-hidden="true"></i>10
                                            Aavailable</a></li>
                                    <li><a href="course-details.html"><i class="fa fa-share-alt" aria-hidden="true"></i>
                                            570</a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div class="home-top-cour">
                        ...
                        <div class="col-md-9 home-top-cour-desc">
                            ...
                            <h4>Technology / software/ programmer</h4>
                            <p>Bu kurs davomida frontend dasturlashni o'rganasiz</p> <span
                                    class="home-top-cour-rat">4.2</span>
                            <div class="hom-list-share">
                                <ul>
                                    <li><a href="course-details.html"><i class="fa fa-bar-chart" aria-hidden="true"></i>Bog'lanish</a>
