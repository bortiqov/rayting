...
<div class="sb2-2">
    ...
    <div class="sb2-2-2">
        <ul>
            ...
            <li class="page-back"><a href="<?= \yii\helpers\Url::to() ?>"><i class="fa fa-backward"
                    ...
                    <div class="tab-inn">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col-md-6 s6">
                                ...
                                <?= $form->field($model, 'birthday')->textInput(['placeholder' => 'Tug\'ilgan sana', 'type' => 'date', 'class' => 'validate'])->label(false) ?>
                            </div>
                            <div class="input-field col-md-6 s6">
                            ...
                            <div class="input-field col-md-6 s6">
                                <?= $form->field($model, 'position')->textInput(['id' => 'list-position', 'placeholder' => 'Lavozim', 'class' => 'validate'])->label(false) ?>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="file-field input-field">
                            ...
                            <div class="file-path-wrapper">
                                <input class="file-path validate" type="text"
                                       placeholder="Upload student avatar image">
                            </div>
                        </div>
                        <div class="row">
