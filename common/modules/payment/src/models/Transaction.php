...
class Transaction extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return \rakhmatov\payment\models\query\TransactionQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \rakhmatov\payment\models\query\TransactionQuery(get_called_class());
    }
