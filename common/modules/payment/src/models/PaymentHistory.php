...
class PaymentHistory extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return \rakhmatov\payment\models\query\PaymentHistoryQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \rakhmatov\payment\models\query\PaymentHistoryQuery(get_called_class());
    }
